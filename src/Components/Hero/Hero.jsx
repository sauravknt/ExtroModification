    ...
    <div className='banner4'>
      <img src={background3} alt="" className='img-main' />
       <div className='text-box'>
        ...
        <span></span>
        <p>Extro Offers A Selection Of High-Puality bathroom fittings that includes elegant faucets and rainfall showerheads. Embedded with a touch of luxury and durability we enhance the experience.
By offering a comprehensive range of bathroom solutions, we aim to create beautiful, functional, and personalized spaces that exceed our clients' expectations.
