...
import cpchoco from '../Assets/bacground/cpprop.jpg'
...
import waterfall from '../Assets/bacground/cpwaterfall.jpg'
  ...
  return (
    <nav className={`container ${sticky? 'dark-nav':''}`} >
      ...
      <ul>
        ...
        <li> <Link style={{textDecoration:'none'}} to='/Waterfall'><img src={waterfall} alt="" className='navimg'/>Waterfall</Link></li>
        ...
        <li> <Link style={{textDecoration:'none'}} to='/Cpchoco'><img src={cpchoco} alt="" className='navimg'/>Pro</Link></li>
